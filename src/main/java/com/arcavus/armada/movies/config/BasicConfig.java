package com.arcavus.armada.movies.config;
...
public class BasicConfig {
    ...
    public ThreadPoolExecutor workers() {
        ...
        return new ThreadPoolExecutor(processors,2 * processors,1,
                TimeUnit.MINUTES,
    ...
    static class DefaultExceptionHandler implements Thread.UncaughtExceptionHandler {
        ...
        public void uncaughtException(Thread thread, Throwable t) {
            log.log(Level.SEVERE,"[threadName: " + thread.getName() + "] message: " + t.getMessage() + ", stackTrace: " + Arrays.toString(t.getStackTrace()));
        }
    }

...
import com.arcavus.armada.movies.dto.links.FindAcquaintanceLinks;
import com.arcavus.armada.movies.dto.links.FindAcquaintanceLinksPrepareSelectedNames;
import com.arcavus.armada.movies.dto.links.FindAcquaintanceLinksResult;
import com.arcavus.armada.movies.dto.links.FindAcquaintanceLinksResults;
import com.arcavus.armada.movies.validator.AcquaintanceLinksValidator;
import com.arcavus.armada.movies.service.links.AcquaintanceLinksService;
...
public class AcquaintanceLinksResource {
    ...
    public HttpEntity<FindAcquaintanceLinksResults> search(@RequestBody FindAcquaintanceLinks findAcquaintanceLinks) {
        ...
        Stream.of(Tuple.of("sourceFullName", sourceFullName),Tuple.of("targetFullName", targetFullName)).forEach(t -> acquaintanceLinksValidator.test(t._1, t._2));
    ...
    @RequestMapping(path = "prepare",method = RequestMethod.POST,consumes = MediaType.APPLICATION_JSON_UTF8_VALUE)
